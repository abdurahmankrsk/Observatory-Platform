...
const SOLAR_BODY_PRESETS = {
  ...
  earth: { radius: 1.4, surfaceStyle: 'terran', oceanColor: col(0.04, 0.24, 0.6), terrainColor: col(0.2, 0.45, 0.16), iceColor: col(0.92, 0.96, 1.0), atmosphereColor: col(0.35, 0.6, 1.0), hasAtmosphere: true, atmosphere: true, atmosphereThickness: 0.1, cloudCoverage: 0.5, rotationSpeed: 0.12, planetFeature: 'earthContinents' },
  ...
  neptune: { radius: 1.65, surfaceStyle: 'bands', bandColorA: col(0.15, 0.30, 0.82), bandColorB: col(0.20, 0.40, 0.90), atmosphereColor: col(0.25, 0.45, 0.92), hasAtmosphere: true, atmosphere: true, atmosphereThickness: 0.11, cloudCoverage: 0, hasRings: false, rotationSpeed: 0.3, noiseScale: 2.0, planetFeature: 'neptuneDarkSpot' },
