...
const SOLAR_BODY_PRESETS = {
  ...
  neptune: { radius: 1.65, surfaceStyle: 'bands', bandColorA: col(0.06, 0.15, 0.45), bandColorB: col(0.12, 0.28, 0.58), atmosphereColor: col(0.15, 0.3, 0.65), hasAtmosphere: true, atmosphere: true, atmosphereThickness: 0.11, cloudCoverage: 0, hasRings: false, rotationSpeed: 0.3, planetFeature: 'neptuneDarkSpot' },
